...
| RN-11 | Solo el encargado puede aprobar o rechazar solicitudes. | Al intentar aprobar o rechazar una solicitud. | Si el usuario no tiene rol encargado, la operación se rechaza. | AMB-02 / AMB-08 / RF-08 | `src/prestamos/reglas.py` (`_validar_usuario_operador`), `src/prestamos/servicios/solicitudes.py` | CP-19, CP-20 |
...
| RN-15 | Una solicitud puede cancelarse solo antes de la entrega. | Al cancelar una solicitud. | Solicitudes solicitadas o aprobadas pasan a cancelada; préstamos entregados, atrasados o devueltos no pueden cancelarse. | AMB-10 / RF-11 | `src/prestamos/servicios/prestamos.py` | CP-27, CP-28 |
